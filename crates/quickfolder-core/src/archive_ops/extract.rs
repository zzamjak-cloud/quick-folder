...
#[cfg(unix)]
use crate::file_ops::{restore_symlink, restore_unix_mode};
...
pub async fn extract_archive(
    ...
    if is_zip_archive_path(Path::new(&archive_path)) {
        return crate::file_ops::extract_zip(archive_path, dest_dir).await;
    }

    let dest_clone = dest_dir.clone();
    tokio::task::spawn_blocking(move || -> Result<crate::file_ops::ExtractResult> {
        ...
        Ok(crate::file_ops::ExtractResult {
