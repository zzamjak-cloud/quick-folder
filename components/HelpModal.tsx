...
const MARKDOWN_SECTIONS = [
  {
    title: '마크다운 편집기 (TipTap)',
    bullets: [
      '.md 파일 선택 후 Enter로 편집기 열기',
      '빈 공간 우클릭 → "마크다운" → 즉시 인라인 이름 변경 + 편집',
      'WYSIWYG 편집 — 헤딩·리스트·체크박스·코드 블록·인용·표',
      '리스트 항목에서 Tab/Shift+Tab으로 들여쓰기/내어쓰기',
    ],
  },
  {
    title: '자동 저장 & 단축키',
  ...
  },
  {
    ...
    bullets: [
      ...
      'MD↔HTML 변환은 marked / turndown 사용',
    ],
  },
  {
